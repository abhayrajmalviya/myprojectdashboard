...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <NavButton title="Notifications"  dotColor='#03C907' customFunc={() => handleClick('notification')} color={currentColor} 
      ...
      >
        ...
        >
          <img src={avatar} alt='my profile pic' className='rounded-full w-8 h-8'/>
          <p>
            <span className='text-gray-400 text-14'>Hii, </span> {' '}
            <span className='text-gray-400 font-bold ml-1 text-14'>Abhayraj Malviya</span>
          </p>
